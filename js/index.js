...
const firstStepBar = document.querySelector(".first_step .number")
const secondStepBar = document.querySelector(".sec_step .number")
...
selects.forEach(select => {
    select.addEventListener("click", e => {
        ...
        secondStepBar.classList.add("active")
