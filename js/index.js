    ...
    // } else {
        switch(stepCount) {
            case 1:                
                ...
                messageBoxContainer.insertAdjacentHTML("beforeend", "")
                ...
                if(personal_info_errors.length) {
                    ...
                    personal_info_errors.forEach(error => {
                        ...
                        messageBoxContainer.insertAdjacentHTML("beforeend", messageBox({headContent: error.type, bodyContent: error.message}))
                    })
                } else {
...
if (localStorage.hasOwnProperty('registerFormData')) {
    ...
    if (registerFormData.hasOwnProperty("personal_info")) {
        ...
        const firstStepDone = `<svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        firstStepBar.innerHTML = firstStepDone
